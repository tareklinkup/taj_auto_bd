							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<v-select v-bind:options="suppliers" v-model="selectedSupplier"
										v-on:input="onChangeSupplier" label="display_name" id="supplier"></v-select>
								</div>
						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-sm-7">
										<v-select v-bind:options="products" v-model="selectedProduct"
											label="display_text" v-on:input="onChangeProduct" id="product"></v-select>
									</div>
									<div class="col-sm-1" style="padding: 0;">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<button type="submit" class="btn btn-default pull-right" id="add2cart"
											v-on:click="openPOnClick">Add
											Cart</button>
									</div>
								</div>
							</form>
