...
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
    ...
    public function getCashLedger() {
        ...
        $ledger = $this->db->query("
            ...
            where pm.status = 'a'
            and pm.PurchaseMaster_BranchID = 1
